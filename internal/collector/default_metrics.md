# Embedded fallback for metric metadata. Keep this file aligned with docs/vertiv_ac_metrics_list.md.
...
| `vertiv_ac_electrical_voltage_phase_a_volts` | 26 | Phase A voltage | 213.8 |
| `vertiv_ac_electrical_voltage_phase_b_volts` | 27 | B phase voltage | 214.9 |
| `vertiv_ac_electrical_voltage_phase_c_volts` | 28 | C phase voltage | 214.9 |
| `vertiv_ac_electrical_frequency_hz` | 29 | Power frequency | 49.9 |
...
| `vertiv_ac_compressor_min_runtime_minutes` | 30 | Compressor shortest running time | 15.0 |
| `vertiv_ac_compressor_min_downtime_minutes` | 31 | Compressor shortest downtime | 2.0 |
...
| `vertiv_ac_compressor_max_capacity_runtime_minutes` | 166 | Maximum capacity of the compressor running time | 120.0 |
| `vertiv_ac_compressor_start_time_seconds` | 167 | Compressor start time | 180.0 |
| `vertiv_ac_compressor_output_dead_zone_percent` | 168 | Compressor output dead zone | 2.8 |
| `vertiv_ac_compressor_oil_return_cycle_minutes` | 169 | Oil return cycle | 240.0 |
| `vertiv_ac_compressor_oil_return_runtime_minutes` | 170 | Oil return running time | 5.0 |
...
| `vertiv_ac_compressor_temp_integration_time_seconds` | 152 | Compressor temperature integration time | 300.0 |
| `vertiv_ac_compressor_temp_differential_time_seconds` | 153 | Compressor temperature differential time | 0.0 |
| `vertiv_ac_compressor_running_hours_total` | 48 | Compressor running hours | 0.0 |
...
| `vertiv_ac_fan_low_speed_step_percent_per_sec` | 179 | Fan low speed step | 0.1 |
| `vertiv_ac_fan_high_speed_step_percent_per_sec` | 180 | Fan high speed step | 1.0 |
| `vertiv_ac_fan_down_delay_seconds` | 181 | Fan down delay | 5.0 |
| `vertiv_ac_fan_start_delay_seconds` | 32 | Fan start delay | 10.0 |
| `vertiv_ac_fan_downtime_seconds` | 33 | Fan downtime | 30.0 |
| `vertiv_ac_fan_temp_proportional_band_celsius` | 154 | Fan temperature proportional band | 13.0 |
| `vertiv_ac_fan_temp_integration_time_seconds` | 155 | Fan temperature integration time | 240.0 |
| `vertiv_ac_fan_running_hours_total` | 50 | Fan running hours | 0.0 |
...
| `vertiv_ac_eev_time_constant_seconds` | 182 | EEV time constant | 60.0 |
| `vertiv_ac_eev_start_opening_percent` | 185 | EEV start opening degree | 65.0 |
| `vertiv_ac_eev_start_time_seconds` | 203 | EEV start time | 60.0 |
| `vertiv_ac_pump_running_hours_total` | 49 | Pump running hours | 1026.0 |
| `vertiv_ac_pump_startstop_records_total` | 44 | Number of pump start and stop records | 50.0 |
| `vertiv_ac_humidifier_running_hours_total` | 52 | Humidifier running hours | 0.0 |
| `vertiv_ac_humidifier_startstop_records_total` | 47 | Number of humidifier start and stop records | 0.0 |
| `vertiv_ac_electric_heating_running_hours_total` | 51 | Electric heating operation hours | 0.0 |
| `vertiv_ac_electric_heating_startstop_records_total` | 46 | Number of electric heating start and stop records | 1.0 |
| `vertiv_ac_dehumidification_runtime_minutes` | 126 | Dehumidification run time | 15.0 |
| `vertiv_ac_filter_maintenance_interval_days` | 123 | Filter maintenance reminder time | 90.0 |
| `vertiv_ac_status_operation` | 5 | Air conditioning operation status | Running[0] |
| `vertiv_ac_status_refrigeration` | 8 | Refrigeration flag | In[0] |
| `vertiv_ac_status_heating` | 11 | Heating flag | NotIn[1] |
...
| `vertiv_ac_status_compressor_output` | 261 | Compressor output | OutputMove[1] |
...
| `vertiv_ac_status_public_alarm_output` | 265 | Public alarm output | OutputMove[1] |
...
| `vertiv_ac_status_fan_1` | 161 | Fan 1 state | Normal[0] |
...
| `vertiv_ac_status_new_alarm_flag` | 311 | New alarm flag | GenerateNewAlarm[1] |
| `vertiv_ac_status_filter_maintenance` | 315 | Filter maintenance | No[0] |
| `vertiv_ac_status_communication` | 91 | Communication Status | Normal[0] |
...
| `vertiv_ac_system_alarm_active_count` | 41 | Number of alarm states |
| `vertiv_ac_system_alarm_history_count` | 42 | Number of alarm history |
| `vertiv_ac_system_software_version_high` | 55 | Software version is high |
| `vertiv_ac_system_software_version_low` | 56 | The software version is low |
| `vertiv_ac_system_monitor_baud_rate` | 24 | Monitor baud rate |
| `vertiv_ac_system_monitor_address` | 25 | Monitor the address |
| `vertiv_ac_system_unit_count` | 106 | Number of units |
| `vertiv_ac_system_main_delay_minutes` | 99 | Main delay |
| `vertiv_ac_system_low_pressure_alarm_delay_seconds` | 121 | Low pressure alarm delay |
| `vertiv_ac_system_short_cycle_alarm_times_per_hour` | 122 | Short cycle alarm value |
| `vertiv_ac_system_exhaust_superheat_low_alarm_delay_sec` | 124 | Exhaust superheat low alarm delay |
